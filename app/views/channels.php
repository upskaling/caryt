...
$category_len = sizeof($category->category);
?>
...
<div>
  ...
  <div class="container py-4">
    ...
    <form action="?c=feed" method="post" class="form-inline">
      <div class="container">
        <div class="form-group mx-sm-3 mb-2 justify-content-center">
          <input type="url" name="add_url" class="long form-control" placeholder="Ajouter un flux RSS" aria-label="Ajouter un flux RSS" />
    ...
    <?php foreach ($category->category as $category_key => $category_name) : ?>
      <div class="card mb-2">
        <div class="card-body">
          <ul class="list-group list-group-flush">
            ...
            <?php foreach ($feedparser->feeds as $key => $value) :
              if (!($category_key == 0 and $value['category'] >= $category_len)) {

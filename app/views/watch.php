...
<div class="card container-xl">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                <?php if (isset($info['like_count']) && isset($info['dislike_count'])) :
                    $info['average_rating'] = $info['like_count'] / ($info['like_count'] + $info['dislike_count']) * 100
                ?>
                    <div class="d-inline-flex">
                        <div id="like_count">
                    ...
                    <div class="progress" style="height: 2px;">
                        <div class="progress-bar bg-secondary" role="progressbar" style="width: <?= $info['average_rating'] ?>%;" aria-valuenow="<?= $info['average_rating'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                <?php endif; ?>
            </div>
        </div>
